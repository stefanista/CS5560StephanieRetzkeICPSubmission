...
object SubjObjTFIDF1 {
  def main(args: Array[String]): Unit ={
    ...
    val input = sc.wholeTextFiles("data1")
...
//      val test = doc._2.replaceAll("\\)\\]", "").replaceAll("\\[\\(", "").replaceAll(":", "").replaceAll("%", "percecnt")
      ...
      val finSen = a.map(sen => {
        val c = sen.replaceAll("\\)\\]", " ").replaceAll("\\[\\(", " ").replaceAll(":", " ").replaceAll("%", "percecnt").replaceAll("(?i)(TNBC)"," ").replaceAll("(?i)(BCa)"," ")
          .replaceAll("(?i)(BC)"," ").replaceAll("'"," ").replaceAll("(NC)","normal control").replaceAll("(LEV)","levetiracetam").replaceAll("(AEDs)","antiepileptic drugs").replaceAll("\\•"," ")
...
//      println(finSen)
    ...
    val stopword = sc.textFile("stopwords.txt")
    ...
    val documentseq = docSansPreds.map(f => {
      ...
      val temp = splitString.map(word => {
        val cw = word.replaceAll(","," ").replaceAll("\\.", " ").replaceAll(":", " ").replaceAll("%", "percecnt").replaceAll("(?i)(TNBC)"," ").replaceAll("(?i)(BCa)"," ")
            .replaceAll("(?i)(BC)"," ").replaceAll("(NC)","normal control").replaceAll("(LEV)","levetiracetam").replaceAll("(AEDs)","antiepileptic drugs").replaceAll("\\•"," ")
...
//      println(f)
    ...
    val pw = new PrintWriter(new File("TF_IDF_Out.txt"))
    pw.write(s)
    pw.close()
